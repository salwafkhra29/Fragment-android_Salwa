...
public class MainActivity extends AppCompatActivity {
    private BottomNavigationView bnvKulinerKitas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bnvKulinerKitas = findViewById(R.id.bnv_kuliner_kitas);
        bnvKulinerKitas.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            @Override
